...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/templates")
...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.delete("https://api.assinafacil.carmoenergy.com/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://api.assinafacil.carmoenergy.com/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/submissions")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/submissions")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/submissions/1001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.delete("https://api.assinafacil.carmoenergy.com/submissions/1001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/submissions/1001/documents")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/submissions/emails")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
  .body("{\"template_id\":1000001,\"emails\":\"hi@assinafacil.carmoenergy.com, example@assinafacil.carmoenergy.com\"}")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/submitters/500001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://api.assinafacil.carmoenergy.com/submitters/500001")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.get("https://api.assinafacil.carmoenergy.com/submitters")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://api.assinafacil.carmoenergy.com/templates/1000001/documents")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/templates/1000001/clone")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/templates/html")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/templates/docx")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/templates/pdf")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.assinafacil.carmoenergy.com/templates/merge")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
